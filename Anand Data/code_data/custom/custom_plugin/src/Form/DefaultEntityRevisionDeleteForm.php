...
class DefaultEntityRevisionDeleteForm extends ConfirmFormBase {
   ...
   *
   * @var \Drupal\custom_plugin\Entity\DefaultEntityInterface
   */
  protected $revision;
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->messenger()->addMessage(t('Revision from %revision-date of Default entity %title has been deleted.', ['%revision-date' => $this->dateFormatter->format($this->revision->getRevisionCreationTime()), '%title' => $this->revision->label()]));
