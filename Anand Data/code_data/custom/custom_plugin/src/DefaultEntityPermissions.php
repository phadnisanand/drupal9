...
use Drupal\custom_plugin\Entity\DefaultEntityType;


/**
 * Provides dynamic permissions for Default entity of different types.
 *
 * @ingroup custom_plugin
 *
 */
class DefaultEntityPermissions{
   ...
   *
   * @return array
   *   The DefaultEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (DefaultEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\custom_plugin\Entity\DefaultEntityType $type
   *   The DefaultEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(DefaultEntityType $type) {
    $type_id = $type->id();
